...
def calculate_sentiment_connection_proportion(graph, sentiment_scores):
    ...
    neutral_proportion = neutral_count / total_connections

    return (positive_positive_proportion, negative_negative_proportion, positive_negative_proportion, negative_positive_proportion, neutral_proportion)
